...
//! arr.concat(); Объединяет массивы ИММУТАБЕЛЬНЫЙ
...
); //* { name: 'abame', age: 69, job: 'ебаный козел', color: 'черножепый' }; возвращает новый и изменяет суммарный объект
console.log(sumObj); //* { name: 'abame', age: 69, job: 'ебаный козел', color: 'черножепый' }; sumObj - суммарный объект
